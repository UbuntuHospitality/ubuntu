...
var ReactFlagsSelect = function(_a) {
  ...
  var _s = __read((0, import_react.useState)(false), 2), isDropdownOpen = _s[0], setIsDropdownOpen = _s[1];
  var _t = __read((0, import_react.useState)([]), 2), countriesOptions = _t[0], setCountriesOptions = _t[1];
  var _u = __read((0, import_react.useState)([]), 2), filteredCountriesOptions = _u[0], setFilteredCountriesOptions = _u[1];
  var _v = __read((0, import_react.useState)(""), 2), filterValue = _v[0], setFilterValue = _v[1];
  ...
  return import_react.default.createElement("div", { className: classnames(styles.flagsSelect, className, (_b = {}, _b[styles.flagsSelectInline] = !fullWidth, _b)), id, "data-testid": "rfs" }, import_react.default.createElement("button", { ref: selectedFlagRef, id: "rfs-btn", type: "button", className: classnames(styles.selectBtn, selectButtonClassName, (_c = {}, _c[styles.disabledBtn] = disabled, _c)), style: { fontSize: selectedSize }, onClick: toggleDropdown, onKeyUp: function(e) {
    return closeDropdwownWithKeyboard(e);
  }, disabled, "aria-labelledby": "rfs-btn", "aria-haspopup": "listbox", "aria-expanded": isDropdownOpen, "data-testid": "rfs-btn" }, import_react.default.createElement("span", { className: styles.selectValue }, validSelectedValue ? import_react.default.createElement(import_react.default.Fragment, null, import_react.default.createElement("span", { className: styles.selectFlag, "data-testid": "rfs-selected-flag" }, getSelectedFlag()), showSelectedLabel && import_react.default.createElement("span", { className: styles.label }, isCustomLabelObject(displayLabel) ? displayLabel.primary : displayLabel), showSecondarySelectedLabel && isCustomLabelObject(displayLabel) && import_react.default.createElement("span", { className: styles.secondaryLabel }, displayLabel.secondary)) : import_react.default.createElement(import_react.default.Fragment, null, placeholder || defaultPlaceholder))), !disabled && isDropdownOpen && import_react.default.createElement("ul", { tabIndex: -1, role: "listbox", ref: optionsRef, style: { fontSize: optionsSize }, className: classnames(styles.selectOptions, (_d = {}, _d[styles.selectOptionsWithSearch] = searchable, _d[styles.alignOptionsToRight] = alignOptionsToRight, _d[styles.fullWidthOptions] = fullWidth, _d)) }, searchable && import_react.default.createElement("div", { className: styles.filterBox }, import_react.default.createElement("input", { type: "text", name: "rfs-q", autoComplete: "off", value: filterValue, placeholder: searchPlaceholder || defaultSearchPlaceholder, ref: filterTextRef, onChange: filterSearch })), options.map(function(countryCode) {
    var _a2;
    ...
    return import_react.default.createElement("li", { key: countryCode, id: "rfs-" + countryCode, role: "option", tabIndex: 0, className: classnames(styles.selectOption, (_a2 = {}, _a2[styles.selectOptionWithlabel] = showOptionLabel, _a2)), onClick: function() {
      return onOptionSelect(countryCode);
    }, onKeyUp: function(e) {
      return onSelectWithKeyboard(e, countryCode);
    } }, import_react.default.createElement("span", { className: styles.selectOptionValue }, import_react.default.createElement("span", { className: styles.selectFlag }, import_react.default.createElement(CountryFlag, null)), showOptionLabel && import_react.default.createElement("span", { className: styles.label }, isCustomLabelObject(countryLabel) ? countryLabel.primary : countryLabel), showSecondaryOptionLabel && isCustomLabelObject(countryLabel) && import_react.default.createElement("span", { className: styles.secondaryLabel }, countryLabel.secondary)));
  })));
};
