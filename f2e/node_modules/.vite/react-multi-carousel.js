...
var require_clones = __commonJS({
  "node_modules/react-multi-carousel/lib/utils/clones.js"(exports) {
    ...
    function checkClonesPosition(_a, childrenArr, props) {
      var isReachingTheEnd, currentSlide = _a.currentSlide, slidesToShow = _a.slidesToShow, itemWidth = _a.itemWidth, totalItems = _a.totalItems, nextSlide = 0, nextPosition = 0, isReachingTheStart = currentSlide === 0, originalFirstSlide = childrenArr.length - (childrenArr.length - 2 * slidesToShow);
      return childrenArr.length < slidesToShow ? (nextPosition = nextSlide = 0, isReachingTheStart = isReachingTheEnd = false) : childrenArr.length > 2 * slidesToShow ? ((isReachingTheEnd = currentSlide >= originalFirstSlide + childrenArr.length) && (nextPosition = -itemWidth * (nextSlide = currentSlide - childrenArr.length)), isReachingTheStart && (nextPosition = -itemWidth * (nextSlide = originalFirstSlide + (childrenArr.length - 2 * slidesToShow)))) : ((isReachingTheEnd = currentSlide >= 2 * childrenArr.length) && (nextPosition = -itemWidth * (nextSlide = currentSlide - childrenArr.length)), isReachingTheStart && (nextPosition = props.showDots ? -itemWidth * (nextSlide = childrenArr.length) : -itemWidth * (nextSlide = totalItems - 2 * slidesToShow))), { isReachingTheEnd, isReachingTheStart, nextSlide, nextPosition };
    }
...
var require_common = __commonJS({
  "node_modules/react-multi-carousel/lib/utils/common.js"(exports) {
    ...
    function getTransformForCenterMode(state, props, transformPlaceHolder) {
      ...
      return !props.infinite && state.currentSlide === 0 || notEnoughChildren(state) ? transform : transform + state.itemWidth / 2;
    }
    ...
    function getTransformForPartialVsibile(state, partialVisibilityGutter, props, transformPlaceHolder) {
      partialVisibilityGutter === void 0 && (partialVisibilityGutter = 0);
...
var require_throttle = __commonJS({
  "node_modules/react-multi-carousel/lib/utils/throttle.js"(exports) {
    ...
    var throttle = function(func, limit, setIsInThrottle) {
      ...
      return function() {
        var args = arguments;
        inThrottle || (func.apply(this, args), inThrottle = true, typeof setIsInThrottle == "function" && setIsInThrottle(true), setTimeout(function() {
          inThrottle = false, typeof setIsInThrottle == "function" && setIsInThrottle(false);
        }, limit));
      };
    };
...
var require_next = __commonJS({
  "node_modules/react-multi-carousel/lib/utils/next.js"(exports) {
    ...
    function populateNextSlides(state, props, slidesHavePassed) {
      slidesHavePassed === void 0 && (slidesHavePassed = 0);
...
var require_previous = __commonJS({
  "node_modules/react-multi-carousel/lib/utils/previous.js"(exports) {
    ...
    function populatePreviousSlides(state, props, slidesHavePassed) {
      ...
      return nextPosition = 0 <= nextMaximumSlides ? (nextSlides = nextMaximumSlides, showDots && !infinite && 0 < additionalSlides && common_2.isInRightEnd(state) && (nextSlides = currentSlide - additionalSlides), -itemWidth * nextSlides) : nextSlides = nextMaximumSlides < 0 && currentSlide !== 0 ? 0 : void 0, { nextSlides, nextPosition };
    }
...
var require_mouseOrTouchMove = __commonJS({
  "node_modules/react-multi-carousel/lib/utils/mouseOrTouchMove.js"(exports) {
    ...
    function populateSlidesOnMouseTouchMove(state, props, initialX, lastX, clientX, transformPlaceHolder) {
      ...
      isMovingLeft && slidesHavePassedLeft <= slidesToShow && (direction = "left", ((nextTranslate = transformPlaceHolder + (clientX - lastX)) <= 0 || currentSlide === 0 && infinite) && (canContinue = true, nextPosition = nextTranslate));
...
var require_Arrows = __commonJS({
  "node_modules/react-multi-carousel/lib/Arrows.js"(exports) {
    ...
    var LeftArrow = function(_a) {
      var customLeftArrow = _a.customLeftArrow, getState = _a.getState, previous = _a.previous, disabled = _a.disabled;
      return customLeftArrow ? React.cloneElement(customLeftArrow, { onClick: function() {
        return previous();
      }, carouselState: getState(), disabled }) : React.createElement("button", { "aria-label": "Go to previous slide", className: "react-multiple-carousel__arrow react-multiple-carousel__arrow--left", onClick: function() {
        return previous();
      }, type: "button", disabled });
    };
    exports.LeftArrow = LeftArrow;
    var RightArrow = function(_a) {
      var customRightArrow = _a.customRightArrow, getState = _a.getState, next = _a.next, disabled = _a.disabled;
      return customRightArrow ? React.cloneElement(customRightArrow, { onClick: function() {
        return next();
      }, carouselState: getState(), disabled }) : React.createElement("button", { "aria-label": "Go to next slide", className: "react-multiple-carousel__arrow react-multiple-carousel__arrow--right", onClick: function() {
        return next();
      }, type: "button", disabled });
    };
  ...
  "node_modules/react-multi-carousel/lib/Carousel.js"(exports) {
    ...
    var Carousel = function(_super) {
      ...
      return __extends(Carousel2, _super), Carousel2.prototype.resetTotalItems = function() {
        ...
        isInThrottle === void 0 && (isInThrottle = false), this.isInThrottle = isInThrottle;
      }, Carousel2.prototype.setTransformDirectly = function(position, withAnimation) {
        var additionalTransfrom = this.props.additionalTransfrom, currentTransform = common_1.getTransform(this.state, this.props, position);
        ...
        this.setState({ domLoaded: true }), this.setItemsToShow(), window.addEventListener("resize", this.onResize), this.onResize(true), this.props.keyBoardControl && window.addEventListener("keyup", this.onKeyUp), this.props.autoPlay && this.props.autoPlaySpeed && (this.autoPlay = setInterval(this.next, this.props.autoPlaySpeed));
      }, Carousel2.prototype.setClones = function(slidesToShow, itemWidth, forResizing, resetCurrentSlide) {
        var _this = this;
        resetCurrentSlide === void 0 && (resetCurrentSlide = false), this.isAnimationAllowed = false;
        ...
        shouldCorrectItemPosition = !!this.props.infinite && (typeof value != "boolean" || !value), this.setItemsToShow(shouldCorrectItemPosition);
        ...
        }, this.props.transitionDuration || defaultTransitionDuration) : this.props.infinite && this.state.currentSlide !== currentSlide && this.correctClonesPosition({ domLoaded }), this.transformPlaceHolder !== this.state.transform && (this.transformPlaceHolder = this.state.transform);
        ...
        if (!utils_1.notEnoughChildren(this.state)) {
          ...
          nextSlides !== void 0 && nextPosition !== void 0 && (typeof beforeChange == "function" && beforeChange(nextSlides, this.getState()), this.isAnimationAllowed = true, this.setState({ transform: nextPosition, currentSlide: nextSlides }, function() {
            typeof afterChange == "function" && setTimeout(function() {
        ...
        if (!utils_1.notEnoughChildren(this.state)) {
          ...
          if (nextSlides !== void 0 && nextPosition !== void 0) {
            var previousSlide = this.state.currentSlide;
            typeof beforeChange == "function" && beforeChange(nextSlides, this.getState()), this.isAnimationAllowed = true, this.setState({ transform: nextPosition, currentSlide: nextSlides }, function() {
              typeof afterChange == "function" && setTimeout(function() {
                afterChange(previousSlide, _this.getState());
              }, _this.props.transitionDuration || defaultTransitionDuration);
            });
        ...
        if (!(!types_1.isMouseMoveEvent(e) && !this.props.swipeable || types_1.isMouseMoveEvent(e) && !this.props.draggable || this.isInThrottle)) {
          var _a = types_1.isMouseMoveEvent(e) ? e : e.touches[0], clientX = _a.clientX, clientY = _a.clientY;
        ...
        if (!(!types_1.isMouseMoveEvent(e) && !this.props.swipeable || types_1.isMouseMoveEvent(e) && !this.props.draggable || utils_1.notEnoughChildren(this.state))) {
          var _a = types_1.isMouseMoveEvent(e) ? e : e.touches[0], clientX = _a.clientX, clientY = _a.clientY, diffX = this.initialX - clientX, diffY = this.initialY - clientY;
          if (this.onMove) {
            ...
            direction && (this.direction = direction, canContinue && nextPosition !== void 0 && this.setTransformDirectly(nextPosition)), this.lastX = clientX;
          }
        }
        ...
        var shouldDisableOnMobile = e.type === "touchend" && !this.props.swipeable, shouldDisableOnDesktop = (e.type === "mouseleave" || e.type === "mouseup") && !this.props.draggable;
        if (!shouldDisableOnMobile && !shouldDisableOnDesktop && this.onMove) {
          if (this.setAnimationDirectly(true), this.direction === "right")
        ...
        var _a = el.getBoundingClientRect(), _b = _a.top, top = _b === void 0 ? 0 : _b, _c = _a.left, left = _c === void 0 ? 0 : _c, _d = _a.bottom, bottom = _d === void 0 ? 0 : _d, _e = _a.right, right = _e === void 0 ? 0 : _e;
      ...
      }, Carousel2.prototype.goToSlide = function(slide, skipCallbacks) {
        var _this = this;
        if (!this.isInThrottle) {
          ...
          typeof beforeChange != "function" || skipCallbacks && (typeof skipCallbacks != "object" || skipCallbacks.skipBeforeChange) || beforeChange(slide, this.getState()), this.isAnimationAllowed = true, this.setState({ currentSlide: slide, transform: -itemWidth * slide }, function() {
            _this.props.infinite && _this.correctClonesPosition({ domLoaded: true }), typeof afterChange != "function" || skipCallbacks && (typeof skipCallbacks != "object" || skipCallbacks.skipAfterChange) || setTimeout(function() {
              afterChange(previousSlide, _this.getState());
            }, _this.props.transitionDuration || defaultTransitionDuration);
          });
        }
        ...
        var _a = this.props, deviceType = _a.deviceType, arrows = _a.arrows, renderArrowsWhenDisabled = _a.renderArrowsWhenDisabled, removeArrowOnDeviceType = _a.removeArrowOnDeviceType, infinite = _a.infinite, containerClass = _a.containerClass, sliderClass = _a.sliderClass, customTransition = _a.customTransition, additionalTransfrom = _a.additionalTransfrom, renderDotsOutside = _a.renderDotsOutside, renderButtonGroupOutside = _a.renderButtonGroupOutside, className = _a.className;
